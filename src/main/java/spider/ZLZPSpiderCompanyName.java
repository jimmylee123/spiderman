...
public class ZLZPSpiderCompanyName {
	private static Logger logger = LoggerFactory.getLogger(ZLZPSpiderCompanyName.class); // 日志记录

	public static void main(String[] args) {
		File f = new File("C:\\lihaixiang\\zlzp\\company\\compayName.txt");
			...
			int code = resultObject.getInt("code");
					...
					if(code == 200){
						...
						for(int i = 0;i<resultsArray.size();i++){
							...
							JSONObject company = dataResult.getJSONObject("company");
							String companyName = company.getString("name");
//							String message = getJAVAMessage(positionURL,bw);
							if(!companyName.equals(preName)){
